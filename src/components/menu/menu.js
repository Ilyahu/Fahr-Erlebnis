...
import ErlebnisseMais from "./erlebnisse-mais"

const MenuErlebnisse = () => {
  const [menuCategory, setMenuCategory] = useState("Maislabyrinth")
  let SelectedCategory
  if (menuCategory === "Maislabyrinth") {
    SelectedCategory = ErlebnisseMais
  } else if (menuCategory === "Kinder") {
            ...
            <ul className="menu-headers">
              <li
                className={cn("menu-header", {
                  active: menuCategory === "Maislabyrinth",
                })}
                onClick={() => setMenuCategory("Maislabyrinth")}
              >
                Maislabyrinth
              </li>
              ...
              <li
                className={cn("menu-header", {
                  active: menuCategory === "Kinder",
                })}
                onClick={() => setMenuCategory("Kinder")}
              >
                Kinder
              </li>
              <li
                className={cn("menu-header", {
                  active: menuCategory === "Schulen",
                })}
                onClick={() => setMenuCategory("Schulen")}
              >
                Schule
              </li>
              ...
              <li
                className={cn("menu-header", {
                  active: menuCategory === "Ferienlager",
                })}
                onClick={() => setMenuCategory("Ferienlager")}
              >
                Ferienlager
              </li>
            </ul>
